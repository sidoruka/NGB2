...
export class Line {
    ...
    renderSimpleRead(read, {arrows, diffBase, ins_del, softClip}) {
        let result = [];
        if (read.isPairedReads) {
            ...
            result = result.concat(this.getReadRenderers(read.leftPair, {
                arrows,
                diffBase,
                ins_del,
                softClip
            }, {isLeftPair: true, isRightPair: false}, commonRange));
            result = result.concat(this.getReadRenderers(read.rightPair, {
                arrows,
                diffBase,
                ins_del,
                softClip
            ...
            result = result.concat(this.getReadRenderers(read, {
                arrows,
                diffBase,
                ins_del,
                softClip
